...
<div class="caja-blanca">
    ...
    <form method="post" id="formulario" class="formulario" action="index2.php" novalidate>
        ...
        <div class="form-derecha">
            <input type="text" datatype="tel" class="input" id="telefono" name="telefono"
                   placeholder="Introduce el télefono" required>
            <p>999 99 99 99</p>
        ...
        <div class="acciones">
            <p>
                ...
                He leído y acepto las <a href="https://aepd.es" target="_blank">políticas de privacidad y de protección
                    de
                    datos</a>
            </p>
            <p class="centrado">
                <input type="submit" class="btn" value="Siguiente" id="enviar" name="enviar" disabled
